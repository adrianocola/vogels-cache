...
describe('vogels-cache',function(){
    ...
    describe('model',function(){
        ...
        describe('query()',function(){
            ...
            it('should cache query result list',function(done){
                ...
                createBars(key,['a','b'],false,function(){
                    CacheableBar.query(key).cacheList(list).exec(function(err,bars){

                        (!err).should.be.ok;
                        bars.cached.should.be.ok;
                        bars.Items.length.should.be.equal(2);

                        redis.exists('bar:'+key+':'+list,function(err,exist){
                            (!err).should.be.ok;
                            exist.should.be.equal(1);
            ...
            it('should not get from cache when using pagination',function(done){

                var CacheableBar = VogelsCache.prepare(Bar);
                var key = 'model-query-4';
                var list = 'query4';
                ...
                createBars(key,['a','b'],false,function(){
                    CacheableBar.query(key).cacheList(list).exec(function(err,bars){
                        ...
                        redis.exists('bar:'+key+':'+list,function(err,exist){
                            ...
                            CacheableBar.query(key).startKey(key,'a').cacheList(list).exec(function(err,bars){

                                (!err).should.be.ok;
                                (!bars.fromCache).should.be.ok;
                                bars.Items.length.should.be.equal(1);
            ...
            it('should remove cached list when a new item is added to that key',function(done){

                var CacheableBar = VogelsCache.prepare(Bar);
                var key = 'model-query-5';
                var list = 'query5';
            ...
            it('should remove cached list when a new items are added to that key',function(done){

                var CacheableBar = VogelsCache.prepare(Bar);
                var key = 'model-query-6';
                var list = 'query6';
            ...
            it('should remove cached list when a an item its update',function(done){

                var CacheableBar = VogelsCache.prepare(Bar);
                var key = 'model-query-7';
                var list = 'query7';
                ...
                createBars(key,['a','b'],false,function(){
                    CacheableBar.query(key).cacheList(list).exec(function(err,bars){
                        ...
                        bars.Items[0].set({data: 'X'});
                        bars.Items[0].update(function(err){
            ...
            it('should remove cached list when a an item is deleted',function(done){

                var CacheableBar = VogelsCache.prepare(Bar);
                var key = 'model-query-8';
                var list = 'query8';
                ...
                createBars(key,['a','b'],false,function(){
                    CacheableBar.query(key).cacheList(list).exec(function(err,bars){
                        ...
                        bars.Items[0].destroy(function(err){
